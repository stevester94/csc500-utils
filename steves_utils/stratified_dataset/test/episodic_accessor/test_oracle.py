...
Test_Episodic_Accessor.domains = ALL_DISTANCES_FEET_NARROWED
...
Test_Episodic_Accessor.pickle_path = os.path.join(get_datasets_base_path(), "/mnt/wd500GB/CSC500/csc500-main/datasets/oracle.Run1_10kExamples_stratified_ds.2022A.pkl")
